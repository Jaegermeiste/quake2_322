...
#define		SUBDIVIDE_SIZE	32	// NeVo - smoother warp divisions
...
void MakeSkyVec (float s, float t, int axis)
{
	...
	b[0] = s * r_skyboxsize->value; // DMP skybox size changes
	b[1] = t * r_skyboxsize->value; // DMP
	b[2] = r_skyboxsize->value;		// DMP
