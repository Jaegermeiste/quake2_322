...
model_t *Mod_LoadModel (model_t *mod, int crash);
...
==================
*/
model_t *Mod_ForName (char *name, int crash)
{
	model_t	*mod;
	unsigned *buf;
	int		i;
...
void R_BeginRegistration (char *model)
{
	...
	r_worldmodel = Mod_ForName(fullname, 1);
