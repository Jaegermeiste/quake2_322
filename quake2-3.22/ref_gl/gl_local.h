...
typedef struct fogmode_s
{
	...
	float fogdensity;
	int   mode;
	int  usecoords;	// Use coordinate fog if possible
} fogmode_t;
...
typedef struct glconfig_s
{
	...
	int 	mtexcombine;
	// Vic - end
	int	glmipmap;		// Gage - SGIS Mipmapping
	int	have_stencil;	// MrG - stencil shadows
	int	anisotropic;		// NeVo - anisotropic filtering
	int	texture_compression;	// Heffo - ARB texture compression
	int	gammaramp;		// MrG - BeefQuake - hardware gammaramp
	int	coordinatefog;	// NeVo - coordinate fog
} glconfig_t;
...
typedef struct glstate_s
{
	...
	int fogenabled;	// NeVo - fog is enabled
} glstate_t;
