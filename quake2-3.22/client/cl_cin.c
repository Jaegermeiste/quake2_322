...
Returns 1 if a cinematic is active, meaning the view rendering
should be skipped
==================
*/
int SCR_DrawCinematic (void)
{
	if (cl.cinematictime <= 0)
	{
		return 0;
	...
	/*// Knightmare/CDawg Cinematic Line Fix
	re.DrawStretchRaw (-2, -2, viddef.width +4, viddef.height +4, 
		cin.width, cin.height, cin.pic);*/
