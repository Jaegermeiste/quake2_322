...
int     snd_musicscaletable[32][256]; // Vic - stereo sound
int     *snd_p, snd_linear_count, snd_vol, music_vol; // Vic - stereo sound
short	*snd_out;
...
void S_PaintChannels(int endtime)
{
	...
	music_vol = s_musicvolume->value*256;	// Vic - stereo sound
	...
	// paint in the channels.
		...
		for (i=0; i<MAX_CHANNELS ; i++, ch++)
		{
			...
			while (ltime < end)
			{
				...
				if (ch->end < end)	// Vic - stereo sound
					count = ch->end - ltime;
