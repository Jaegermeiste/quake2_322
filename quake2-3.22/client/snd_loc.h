...
typedef struct playsound_s
{
	...
	int			entnum;
	int			entchannel;
	int	fixed_origin;	// use origin field instead of entnum's origin
	vec3_t		origin;
...
typedef struct channel_s
{
	...
	int	fixed_origin;	// use origin instead of fetching entnum's origin
	int	autosound;		// from an entity->sound, cleared each frame
} channel_t;
...
#define MAX_RAW_SAMPLES 16384		// Vic - stereo sound
...
extern cvar_t   *s_musicvolume;		// Vic - stereo sound
extern cvar_t   *s_swapstereo;		// Vic - stereo sound

wavinfo_t GetWavinfo (char *name, byte *wav, int wavlength);

void S_InitScaletable (void);
void S_InitMusicScaletable (void); // Vic - stereo sound
