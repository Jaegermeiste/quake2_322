...
*****************************/
extern qboolean G_EntExists(edict_t *ent);
extern qboolean G_ClientNotDead(edict_t *ent);
extern qboolean G_ClientInGame(edict_t *ent);
extern qboolean G_Within_Radius(vec3_t start, vec3_t end, float rad);
