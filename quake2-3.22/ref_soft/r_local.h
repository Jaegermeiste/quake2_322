...
/*
NeVo - this switch turns off assembly
Done primarily because the Intel compiler/.NET 2003 bitched and whined
wasn't linking the assembly properly
*/
#define QNOASM	// To reenable assmebly code, comment this out
...
extern	cvar_t	*r_crashhack;
extern	cvar_t	*vid_widescreen;
