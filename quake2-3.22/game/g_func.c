...
} /* statler - Think_RotateDecel */

// statler - accelerating func_rotates
...
void SP_func_rotating (edict_t *ent)
{
	...
	ent->moveinfo.state = STATE_STOPPED; // statler - rotating thingy starts out idle
...
void door_use_areaportals (edict_t *self, int open)
{
	edict_t	*t = NULL;
