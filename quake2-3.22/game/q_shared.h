...
typedef float vec_t;
typedef vec_t vec1_t;		// NeVo
typedef vec_t vec2_t[2];	// NeVo
typedef vec_t vec3_t[3];
typedef vec_t vec4_t[4];	// NeVo
...
{
	int	allsolid;	// if 1, plane is not valid
	int	startsolid;	// if 1, the initial point was in a solid area
...
// NeVo - bobbing item overloads
#define EF_ROTATE_ZHACKDOWN	EF_TRACKERTRAIL
#define EF_ROTATE_ZHACKUP	EF_SPINNINGLIGHTS
