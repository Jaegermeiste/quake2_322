...
/*
NeVo - this is David Hyde's Chick code for Lazarus, which makes the dumb bitch
not so dumb. I've made some modifications to bring it down to the 3.22 level.
*/
void ChickRocket (edict_t *self)
{
