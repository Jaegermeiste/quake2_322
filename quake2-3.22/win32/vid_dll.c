...
// one update sometimes, so we always check all states and look for events
	...
	case WM_SYSKEYDOWN:
		...
		// fall through
	case WM_KEYDOWN:
		Key_Event( MapKey( lParam ), 1, sys_msg_time);
		break;

	case WM_SYSKEYUP:
	case WM_KEYUP:
		Key_Event( MapKey( lParam ), 0, sys_msg_time);
		break;
...
{
	vid_ref->modified = 1;
	vid_gamma->modified = 1;		// NeVo - force gamma update on restart
}
...
vidmode_t vid_modes[] =
{
	...
	{ "Mode 06: 1024x480",  1024, 480,  6  },     // c14 new mode - Sony PictureBook C1VFK support
	{ "Mode 07: 1024x768",  1024, 768,  7  },
	{ "Mode 08: 1152x864",  1152, 864,  8  },
	{ "Mode 09: 1280x768",  1280, 768,  9  },	  // David M. Pochron
	{ "Mode 10: 1280x960",  1280, 960,  10 },
	{ "Mode 11: 1280x1024", 1280, 1024, 11 },     // TheInvisible
	{ "Mode 12: 1600x1200", 1600, 1200, 12 },
	{ "Mode 13: 2048x1536", 2048, 1536, 13 },
	// NeVo - World Video Output Resolutions
	{ "Mode 14: Std. NTSC 601 720x540",	   720,  540,  14 },
	{ "Mode 15: Std. NTSC DV/DVD 720x534", 720,  534,  15 },
	{ "Mode 16: Wide NTSC 601 864x486",	   864,  486,  16 },
	{ "Mode 17: Wide NTSC DV/DVD 864x480", 864,  480,  17 },
	{ "Mode 18: Std. PAL 768x576",		   768,  576,  18 },
	{ "Mode 19: Wide PAL 1024x576",		   1024, 576,  19 },
	{ "Mode 20: HDTV 720P 1280x720",	   1280, 720,  20 },
	{ "Mode 21: HDTV 1080i 1920x1080",	   1920, 1080, 21 }
};
...
void VID_UpdateWindowPosAndSize( int x, int y )
{
	...
	MoveWindow( cl_hwnd, vid_xpos->value, vid_ypos->value, w, h, 1 );
}
