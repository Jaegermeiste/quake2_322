...
/*
NeVo - we have two different compilers and thus two different levels of 
anal retentiveness... the Intel winning that match. To make it happy
we actually have to reverse a hack made to get the thing to compile on
.NET 2002, so I'll add a #define switch
*/
//#define QDDRAWCOMPILERHACK		// Uncommment this for the Microsoft compiler

typedef struct swwstate_s
{
	HINSTANCE		hInstance;
	void			*wndproc;
