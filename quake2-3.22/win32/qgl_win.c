...
int  ( WINAPI * qwglSetPixelFormat)(HDC, int, CONST PIXELFORMATDESCRIPTOR *);
int  ( WINAPI * qwglSwapBuffers)(HDC);

int  ( WINAPI * qwglCopyContext)(HGLRC, HGLRC, UINT);
HGLRC ( WINAPI * qwglCreateContext)(HDC);
HGLRC ( WINAPI * qwglCreateLayerContext)(HDC, int);
int  ( WINAPI * qwglDeleteContext)(HGLRC);
HGLRC ( WINAPI * qwglGetCurrentContext)(VOID);
HDC   ( WINAPI * qwglGetCurrentDC)(VOID);
PROC  ( WINAPI * qwglGetProcAddress)(LPCSTR);
int  ( WINAPI * qwglMakeCurrent)(HDC, HGLRC);
int  ( WINAPI * qwglShareLists)(HGLRC, HGLRC);
int  ( WINAPI * qwglUseFontBitmaps)(HDC, DWORD, DWORD, DWORD);

int  ( WINAPI * qwglUseFontOutlines)(HDC, DWORD, DWORD, DWORD, FLOAT,
                                           FLOAT, int, LPGLYPHMETRICSFLOAT);

int ( WINAPI * qwglDescribeLayerPlane)(HDC, int, int, UINT,
                                            LPLAYERPLANEDESCRIPTOR);
int  ( WINAPI * qwglSetLayerPaletteEntries)(HDC, int, int, int,
                                                CONST COLORREF *);
int  ( WINAPI * qwglGetLayerPaletteEntries)(HDC, int, int, int,
                                                COLORREF *);
int ( WINAPI * qwglRealizeLayerPalette)(HDC, int, int);
int ( WINAPI * qwglSwapLayerBuffers)(HDC, UINT);
...
int ( WINAPI * qwglGetDeviceGammaRampEXT)( unsigned char *, unsigned char *, unsigned char * );
int ( WINAPI * qwglSetDeviceGammaRampEXT)( const unsigned char *, const unsigned char *, const unsigned char * );
...
void GLimp_EnableLogging( int enable )
{
	if ( enable )
	{
		if ( !glw_state.log_fp )
